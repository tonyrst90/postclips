...
export const areaSpalineCharts: ApexOptions = {
  series: [
    {
      name: "series1",
...
export var columnChartData: ApexOptions = {
  chart: {
    height: 350,
    type: "bar",
    toolbar: {
...
export var bubbleChartData: ApexOptions = {
  chart: {
    height: 350,
    type: "bubble",
    toolbar: {
  ...
  colors: ["#003FDD", "#EBA31D", "#51bb25", "#f8d62b"],
};

export var steplineChartData: ApexOptions = {
  chart: {
    type: "line",
    height: 350,
    toolbar: {
...
export const lineWithAnnotationChartData: ApexOptions = {
  annotations: {
    yaxis: [
      {
        y: 8200,
...
export var pieChartData: ApexOptions = {
  chart: {
    width: 380,
    type: "pie",
  },
  ...
  colors: ["#003FDD", "#EBA31D", "#51bb25", "#a927f9", "#f8d62b"],
};

export var donutChartData: ApexOptions = {
  chart: {
    width: 380,
    type: "donut",
  },
  series: [44, 55, 41, 17, 15],
  colors: ["#dc3545", "#f8d62b", "#003FDD", "#51bb25", "#a927f9"],
};

export var mixedChartData: ApexOptions = {
  chart: {
    height: 350,
    type: "line",
    stacked: false,
...
export var candleStickChartData: ApexOptions = {
  chart: {
    height: 350,
    type: "candlestick",
    toolbar: {
...
export var radarChartsData: ApexOptions = {
  chart: {
    height: 350,
    type: "radar",
    toolbar: {
...
export var radialBarChartData: ApexOptions = {
  chart: {
    height: 350,
    type: "radialBar",
  },
  ...
  colors: ["#EBA31D", "#51bb25", "#f8d62b", "#003FDD"],
};
