import { GroupButton, NestingIconDataItem, RadioCheckboxItem } from "@/Types/Buttons.type";
...
export const nestingButtonSpan = [
  {
    text: "Make nesting buttons",
  },
];

export const verticalText = [
  {
    text: "Make vertical buttons",
  },
];