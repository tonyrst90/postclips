    ...
    Items: [
      {
        ...
        active: false,
        children: [
          { path: "/app/project/project_list", type: "link", title: "Project List" },
          { path: "/app/project/project_create", type: "link", title: "Create New" },
        ],
      },
      { path: "/app/file_manager", icon: "file", title: "File Manager", type: "link" },
      {
        ...
        active: false,
        children: [
          { path: "/app/ecommerce/add_product", title: "Add Product", type: "link" },
          { path: "/app/ecommerce/product", title: "Product", type: "link" },
          { path: "/app/ecommerce/product_page", title: "Product Page", type: "link" },
          { path: "/app/ecommerce/product_list", title: "Product List", type: "link" },
          { path: "/app/ecommerce/payment_details", title: "Payment Details", type: "link" },
          { path: "/app/ecommerce/recent_order", title: "Order History", type: "link" },
          {
            title: "Invoices",
            type: "sub",
            children: [
              { path: "/app/ecommerce/invoice/invoice_1", title: "Invoice-1", type: "link" },
              { path: "/app/ecommerce/invoice/invoice_2", title: "Invoice-2", type: "link" },
              { path: "/app/ecommerce/invoice/invoice_3", title: "Invoice-3", type: "link" },
              { path: "/app/ecommerce/invoice/invoice_4", title: "Invoice-4", type: "link" },
              { path: "/app/ecommerce/invoice/invoice_5", title: "Invoice-5", type: "link" },
              { path: "/app/ecommerce/invoice/invoice_6", title: "Invoice-6", type: "link" },
            ],
          },
      ...
      },
      {
        ...
        active: false,
        children: [
          { path: "/app/email/email_application", title: "Email App", type: "link" },
          { path: "/app/email/email_compose", title: "Email Compose", type: "link" },
          { path: "/app/email/letter_box", title: "Letter Box", type: "link", }
        ],
      },
      {
        title: "Chat",
        ...
        active: false,
        children: [
          { path: "/app/chat/private_chat", type: "link", title: "Private Chat" },
          { path: "/app/chat/group_chat", type: "link", title: "Group Chat" },
        ],
      },
      {
        title: "Users",
        ...
        active: false,
        children: [
          { path: "/app/users/user_profile", type: "link", title: "User Profile" },
          { path: "/app/users/edit_profile", type: "link", title: "User Edit" },
          { path: "/app/users/user_cards", type: "link", title: "User Cards" },
        ],
      },
    ...
    Items: [
...

      {
        ...
        children: [
          ...
          { path: "/charts/chart_JS_chart", type: "link", title: "ChartJS Chart" },
        ],
      },
    ],
  },
        ...
        children: [
          ...
          },
          {
            ...
            children: [
              ...
              { path: "/others/authentication/loginbgimage", title: "Login Bg Image", type: "link" },
              { path: "/others/authentication/loginbgimagetwo", title: "Login Image Two", type: "link" },
              { path: "/others/authentication/loginvalidation", title: "Login Validation", type: "link" },
              { path: "/others/authentication/logintooltip", title: "Login Tooltip", type: "link" },
              { path: "/others/authentication/loginsweetalert", title: "Login Sweetalert", type: "link" },
              { path: "/others/authentication/registersimple", title: "Register Simple", type: "link" },
              { path: "/others/authentication/registerbgimage", title: "Register Image", type: "link" },
              { path: "/others/authentication/registerbgimagetwo", title: "Register Two", type: "link" },
    ...
    Items: [
      {
        ...
        active: false,
        children: [
          { path: "/gallery/gallery_grids", title: "Gallery Grid", type: "link" },
          ...
          { path: "/gallery/hover_effect", title: "Hover Effects", type: "link" },
        ],
      },
      ...
      { path: "/miscellaneous/faq", icon: "faq", type: "link", active: false, title: "FAQ" },
      {
        ...
        children: [
          ...
          { path: "/job_search/job_detail", title: "Job Details", type: "link" },
      ...
      { id: 33, path: "/miscellaneous/support_ticket", icon: "support-tickets", type: "link", active: false, title: "Support Ticket" },
    ],
  },
];
